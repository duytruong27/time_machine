...
class PatternFields {
  ...
  static final Map<PatternFields, String> _nameMap = {
    ...
    hours24: 'Weeks',
    minutes: 'Days',
    seconds: 'AllDateUnits',
    fractionalSeconds: 'YearMonthDay',
    amPm: 'AmPm',
    year: 'Year',
    yearTwoDigits: 'YearTwoDigits',
    yearOfEra: 'YearOfEra',
    monthOfYearNumeric: 'MonthOfYearNumeric',
    monthOfYearText: 'MonthOfYearText',
  ...
  static const PatternFields yearTwoDigits =
      const PatternFields(1 << 8); // Actually year of *era* as two digits...
  ...
  static const PatternFields totalTime =
      const PatternFields(1 << 19); // D, H, M, or S in a DurationPattern.
  static const PatternFields embeddedDate = const PatternFields(1 <<
      20); // No other date fields permitted, use calendar/year/month/day from bucket
  static const PatternFields embeddedTime = const PatternFields(1 <<
      21); // No other time fields permitted, user hours24/minutes/seconds/fractional seconds from bucket
  ...
  operator ==(dynamic other) =>
      other is PatternFields && other._value == _value ||
  ...
  PatternFields operator |(PatternFields other) =>
      PatternFields(_value | other.value);
  PatternFields operator &(PatternFields other) =>
      PatternFields(_value & other.value);
  ...
  bool hasAll(PatternFields target) =>
      (_value & target._value) == target._value;
}
