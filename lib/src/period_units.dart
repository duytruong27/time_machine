...
class PeriodUnits {
  ...
  static const PeriodUnits allDateUnits =
      const PeriodUnits(15); // union(const [years, months, weeks, days]);
  /// Compound value representing the combination of [years], [months] and [days]
  static const PeriodUnits yearMonthDay =
      const PeriodUnits(11); // union(const [years, months, days]);
  ...
  static const PeriodUnits hourMinuteSecond =
      const PeriodUnits(112); // union(const [hours, minutes, seconds]);
  /// Compound value representing the combination of all time elements
  static const PeriodUnits allTimeUnits = const PeriodUnits(
      1008); // union(const [hours, minutes, seconds, milliseconds, microseconds, nanoseconds]);
  /// Compound value representing the combination of all possible elements except weeks
  static const PeriodUnits dateAndTime = const PeriodUnits(
      1019); // union(const [years, months, days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds]);
  /// Compound value representing the combination of all possible elements
  static const PeriodUnits allUnits = const PeriodUnits(
      1023); // union(const [years, months, weeks, days, hours, minutes, seconds, milliseconds, microseconds, nanoseconds]);
  ...
  PeriodUnits operator |(PeriodUnits other) =>
      PeriodUnits(_value | other.value);
  PeriodUnits operator &(PeriodUnits other) =>
      PeriodUnits(_value & other.value);
