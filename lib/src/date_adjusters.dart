...
class DateAdjusters {
  ...
  static final LocalDate Function(LocalDate) endOfMonth = (date) => LocalDate(
      date.year,
      date.monthOfYear,
      date.calendar.getDaysInMonth(date.year, date.monthOfYear),
      date.calendar);
  ...
  static LocalDate Function(LocalDate) nextOrSame(DayOfWeek dayOfWeek) {
    ...
    if (dayOfWeek < DayOfWeek.monday || dayOfWeek > DayOfWeek.sunday) {
      throw RangeError.range(dayOfWeek.value, DayOfWeek.monday.value,
          DayOfWeek.sunday.value, 'dayOfWeek');
    }
  ...
  static LocalDate Function(LocalDate) previousOrSame(DayOfWeek dayOfWeek) {
    ...
    return (date) =>
        date.dayOfWeek == dayOfWeek ? date : date.previous(dayOfWeek);
  }
