...
class OffsetDate {
  ...
  OffsetDateTime at(LocalTime time) =>
      OffsetDateTime(calendarDate.at(time), offset);

  /// Returns a hash code for this offset date.
  @override
  int get hashCode => hash2(calendarDate, offset);
  ...
  bool equals(OffsetDate other) =>
      calendarDate == other.calendarDate && offset == other.offset;
