...
abstract class GJYearMonthDayCalculator extends RegularYearMonthDayCalculator {
  ...
  // read them.
  @protected
  static final List<int> minDaysPerMonth = const [
    31,
    28,
    31,
    30,
  ...
  @protected
  static final List<int> maxDaysPerMonth = const [
    31,
    29,
    31,
    30,
 ...
 */
  ...
  static final List<int> _minTotalDaysByMonth = const [
    0,
    31,
    59,
    90,
  ...
  static final List<int> _maxTotalDaysByMonth = const [
    0,
    31,
    60,
    91,
