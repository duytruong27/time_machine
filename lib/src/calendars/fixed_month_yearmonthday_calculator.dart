...
@internal
abstract class FixedMonthYearMonthDayCalculator
    extends RegularYearMonthDayCalculator {
  static const int _daysInMonth = 30;

  static const int _averageDaysPer10Years =
      3653; // Ideally 365.25 days per year...

  @protected
  FixedMonthYearMonthDayCalculator(
      int minYear, int maxYear, int daysAtStartOfYear1)
      : super(
            minYear, maxYear, 13, _averageDaysPer10Years, daysAtStartOfYear1) {}
  ...
  @override
  int getDaysInMonth(int year, int month) => month != 13
      ? _daysInMonth
      : isLeapYear(year)
          ? 6
          : 5;
